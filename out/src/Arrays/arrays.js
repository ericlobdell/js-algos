System.register("../../../src/Arrays/arrays", [], function() {
  "use strict";
  var __moduleName = "../../../src/Arrays/arrays";
  (function(window) {
    ...
    Array.matrix = function(numRows, numCols, initial) {
      ...
      for (var i = 0; i < numRows; ++i) {
        ...
        for (var j = 0; j < numCols; ++j) {
          $traceurRuntime.setProperty(columns, j, initial);
        }
        $traceurRuntime.setProperty(arr, i, columns);
      }
      return arr;
    };
    function temps() {
      ...
      return {
        ...
        add: function(temp, date) {
          ...
          $traceurRuntime.setProperty(this.dataStore[$traceurRuntime.toProperty(position.week)], position.day, temp);
        },
        weekAverage: function(week) {
          var weekTemps = this.dataStore[$traceurRuntime.toProperty(week)];
        ...
        monthAverage: function() {
          ...
          for (; i < NUM_ROWS; ++i) {
            total += this.dataStore[$traceurRuntime.toProperty(i)].reduce(sum);
          }
